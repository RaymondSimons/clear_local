        ...
        if os.path.isfile(field + '_' + '%.5i.beams.fits'%id):
            ...
            if pfit != None:
                ...
                try:
                    ...
                    fig.savefig('{0}_v3.0_diff_{1:05d}.stack.png'.format(field, id))
                    hdu.writeto('{0}_v3.0_diff_{1:05d}.stack.fits'.format(field, id), clobber=True)
                except:
                    pass
                ...
                try:
                    out = grizli.fitting.run_all(
                        ...
                        dz=[0.004, 0.0005], 
                        fitter='nnls',
                        group_name=field + '_v3.0',# + '_%i'%phot_scale_order,
