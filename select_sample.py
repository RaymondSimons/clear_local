...
for c, cat_fl in enumerate(cat_fls):
    ...
    gd_num = bw_good_R23.astype('int') + bw_good_R2.astype('int') + bw_good_R3.astype('int') + bw_good_S2.astype('int') + bw_good_O32.astype('int') + bw_good_Ne3O2.astype('int') + bw_good_O3S2.astype('int') + bw_good_HaHb.astype('int')
